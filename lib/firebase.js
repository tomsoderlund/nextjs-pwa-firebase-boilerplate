...
const articleRef = (articleId) => articlesCollection().doc(articleId)

// Example: extending the database with Comments
// const commentsCollection = (articleId) => articleRef(articleId).collection('comments')
// const commentRef = (articleId, commentId) => commentsCollection(articleId).doc(commentId)
